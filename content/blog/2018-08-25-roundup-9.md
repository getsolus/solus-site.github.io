...
This coming week will be full of QoL improvements and updates. We have some items targeted for specific days of the week (including this weekend), others will be addressed throughout the week or after next week's sync. While we'll have a summarized list below of what to expect, the full list is available [here](https://dev.solus-project.com/T6823).
