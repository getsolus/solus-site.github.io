...
4. Attempt to logout using the respective graphical menu options available in Budgie's User Indicator applet, GNOME Shell, Brisk Menu, or Plasma's application launcher (depending on the desktop environment you use).
