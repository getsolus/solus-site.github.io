...
url: "/2020/01/27/solus-4-1-released"
---

We are proud to announce the immediate availability of Solus 4.1 Fortitude, a new Solus 4 series release. This release delivers a brand new desktop experience,  updated sets of software, and hardware enablement.
<!--more-->
...
For audio and video multimedia playback, we offer varying software out-of-the-box that caters best to our desired experience for that edition.
...
Mesa has been upgraded to the latest release, 19.3.2. Mesa 19.3 introduces OpenGL 4.6 support (for supported cards) as well as a wide variety of improvements for AMD APUs (Raven Ridge) and Intel Iris Pro Graphics.
...
- Added a '802-1x.optional' property to consider the wired 802.1X authentication as optional.
...
Solus Plasma Edition ships with various changes to defaults for KDE Applications and Frameworks, such as:
...
- [Konversation](http://konversation.kde.org) has default IRC Program with setup IRC `#Solus` server for support.
