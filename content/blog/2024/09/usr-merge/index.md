...
1) eopkg is updated with Usr-Merge support. It will write a marker file to indicate that the system can safely be merged.
...
Migration to a new package repository has actually been done before on Solus. Most recently, it was done when the [repositories were moved](https://getsol.us/2018/09/11/package-repo-migration-now-available/) to the infrastructure at the Rochester Institute of Technology.
...
Stage *n+1*: All users have been merged; do the Epoch bump. Users start getting updates from the new repository, and everyone is on a Usr Merged system! :tada:
